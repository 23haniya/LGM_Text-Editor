...
public class TextEditor extends JFrame implements ActionListener {
    ...
    public TextEditor() {
        ...
        setTitle("Text Editor | Haniya Akhtar");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == newMenuItem) {
        	...
        	JOptionPane.showMessageDialog(this,"**Text Editor Application**\nMade By: Haniya Akhtar\nEmail: 23haniya@gmail.com\nPhone: 6207187726","About",JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void openFile() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                getContentPane().setBackground(new Color(255, 255, 0)); // Set the background color to yellow
